<?php
/**
 * PH35 サンプル3 マスタテーブル管理DAO版 Src06/13
 *
 * @author Shinzo SAITO
 *
 * ファイル名=DeptDAO.php
 * フォルダ=/ph35/scottadmindao/classes/dao/
 */
...
class DeptDAO {
     ...
     * @return Dept 該当するeptオブジェクト。ｔだし、該当データがない場合はnull。
     */
     ...
     * 部門情報更新。更新対象は1レコードのみ。
     * 
     * @param Dept $dept更新情報が格納されたDeptオブジェクト。主キーがこのオブジェクトのidの値のレコードを更新する。
