<?php
/**
 * PH35 サンプル3 マスタテーブル管理DAO版 Src07/13
 * 部門情報リスト表示。
 *
 * @author Shinzo SAITO
 *
...
<html lang="ja">
    <head>
        ...
        <title>部門情報リスト | ScottAdminDAO Sample</title>
    ...
    <body>
        ...
        <section>
            <p>
                新規登録は<a href="/ph35/scottadmindao/public/dept/goDeptAdd.php">こちら</a>から
            </p>
...
?>
                    <tr>
                        ...
                        <td><?= $dept->getDpLoc() ?></td>
                        <td>
                            <form action="/ph35/scottadmindao/public/dept/prepareDeptEdit.php" method="post">
                                <input type="hidden" id="editDeptId<?= $dept->getId() ?>" name="editDeptId" value="<?= $dept->getId() ?>">
                                <button type="submit">編集</button>
                            </form>
                        </td>
                        <td>
                            <form action="/ph35/scottadmindao/public/dept/confirmDeptDelete.php" method="post">
