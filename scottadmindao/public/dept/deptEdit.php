...
elseif(!empty($validationMsgs)) {
    header("Location: /ph35/scottadmindao/public/dept/prepareDeptEdit.php");
    exit;
}
?>
...
<html lang="ja">
    ...
    <body>
        ...
        <section>
            ...
            <p>
                部門リストに<a href="/ph35/scottadmindao/public/dept/showDeptList.php">戻る</a>
            </p>
        </section>
    </body>
</html>