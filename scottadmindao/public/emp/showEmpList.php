...
<html lang="ja">
    ...
    <body>
        ...
        <nav id="breadcrumbs">
            <ul>
                <li><a href="/ph35/scottadmin/publicdao/">TOP</a></li>
                <li>従業員情報リスト</li>
            </ul>
        </nav>
        <section>
...
?>
                    <tr>
                        ...
                        <td><?= $emp->getDeptId() ?></td>
                        <td>
                            <form action="/ph35/scottadmindao/public/emp/prepareEmpEdit.php" method="post">
                                <input type="hidden" id="editEmpId<?= $emp->getId() ?>" name="editEmpId" value="<?= $emp->getId() ?>">
                                <button type="submit">編集</button>
                            </form>
                        </td>
                        <td>
                            <form action="/ph35/scottadmindao/public/emp/confirmEmpDelete.php" method="post">
